...
void TraderApi::OnQueryOrderByPage(XTPQueryOrderRsp *order_info, int64_t req_count, int64_t order_sequence,
...
void TraderApi::OnQueryTradeByPage(XTPQueryTradeRsp *trade_info, int64_t req_count, int64_t trade_sequence,
                                   int64_t query_reference, int request_id, bool is_last, uint64_t session_id) {
    Task *task = new Task();
...
void
TraderApi::OnQueryAsset(XTPQueryAssetRsp *asset, XTPRI *error_info, int request_id, bool is_last, uint64_t session_id) {
    Task *task = new Task();
...
void TraderApi::OnQueryStructuredFund(XTPStructuredFundInfo *fund_info, XTPRI *error_info, int request_id, bool is_last,
                                      uint64_t session_id) {
    Task *task = new Task();
...
void TraderApi::OnQueryFundTransfer(XTPFundTransferNotice *fund_transfer_info, XTPRI *error_info, int request_id,
...
void TraderApi::OnQueryETF(XTPQueryETFBaseRsp *etf_info, XTPRI *error_info, int request_id, bool is_last,
                           uint64_t session_id) {
    Task *task = new Task();
...
void TraderApi::OnQueryETFBasket(XTPQueryETFComponentRsp *etf_component_info, XTPRI *error_info, int request_id,
                                 bool is_last, uint64_t session_id) {
    Task *task = new Task();
...
void TraderApi::OnQueryIPOInfoList(XTPQueryIPOTickerRsp *ipo_info, XTPRI *error_info, int request_id, bool is_last,
                                   uint64_t session_id) {
    Task *task = new Task();
...
void TraderApi::OnQueryIPOQuotaInfo(XTPQueryIPOQuotaRsp *quota_info, XTPRI *error_info, int request_id, bool is_last,
                                    uint64_t session_id) {
    Task *task = new Task();
...
void TraderApi::OnQueryOptionAuctionInfo(XTPQueryOptionAuctionInfoRsp *option_info, XTPRI *error_info, int request_id,
                                         bool is_last, uint64_t session_id) {
    Task *task = new Task();
...
void TraderApi::OnQueryCreditCashRepayInfo(XTPCrdCashRepayInfo *cash_repay_info, XTPRI *error_info, int request_id,
                                           bool is_last, uint64_t session_id) {
...
void
TraderApi::OnQueryCreditFundInfo(XTPCrdFundInfo *fund_info, XTPRI *error_info, int request_id, uint64_t session_id) {
...
void TraderApi::OnQueryCreditDebtInfo(XTPCrdDebtInfo *debt_info, XTPRI *error_info, int request_id, bool is_last,
                                      uint64_t session_id) {
...
void
TraderApi::OnQueryCreditTickerDebtInfo(XTPCrdDebtStockInfo *debt_info, XTPRI *error_info, int request_id, bool is_last,
                                       uint64_t session_id) {
...
void
TraderApi::OnQueryCreditAssetDebtInfo(double remain_amount, XTPRI *error_info, int request_id, uint64_t session_id) {
...
void TraderApi::OnQueryCreditTickerAssignInfo(XTPClientQueryCrdPositionStkInfo *assign_info, XTPRI *error_info,
...
void
TraderApi::OnQueryCreditExcessStock(XTPClientQueryCrdSurplusStkRspInfo *stock_info, XTPRI *error_info, int request_id,
                                    uint64_t session_id) {
...
void TraderApi::OnQueryMulCreditExcessStock(XTPClientQueryCrdSurplusStkRspInfo *stock_info, XTPRI *error_info,
                                            int request_id, uint64_t session_id, bool is_last) {
...
void
TraderApi::OnCreditExtendDebtDate(XTPCreditDebtExtendNotice *debt_extend_info, XTPRI *error_info, uint64_t session_id) {
...
void TraderApi::OnQueryCreditExtendDebtDateOrders(XTPCreditDebtExtendNotice *debt_extend_info, XTPRI *error_info,
                                                  int request_id, bool is_last, uint64_t session_id) {
...
void TraderApi::OnQueryCreditFundExtraInfo(XTPCrdFundExtraInfo *fund_info, XTPRI *error_info, int request_id,
                                           uint64_t session_id) {
...
void TraderApi::OnQueryCreditPositionExtraInfo(XTPCrdPositionExtraInfo *fund_info, XTPRI *error_info, int request_id,
                                               bool is_last, uint64_t session_id) {
...
void TraderApi::OnCreditCashRepayDebtInterestFee(XTPCrdCashRepayDebtInterestFeeRsp *cash_repay_info, XTPRI *error_info,
                                                 uint64_t session_id) {
...
void
TraderApi::OnCancelOptionCombinedOrderError(XTPOrderCancelInfo *cancel_info, XTPRI *error_info, uint64_t session_id) {
...
void TraderApi::OnQueryOptionCombinedOrders(XTPQueryOptCombOrderRsp *order_info, XTPRI *error_info, int request_id,
                                            bool is_last, uint64_t session_id) {
...
void TraderApi::OnQueryOptionCombinedOrdersByPage(XTPQueryOptCombOrderRsp *order_info, int64_t req_count,
                                                  int64_t order_sequence, int64_t query_reference, int request_id,
                                                  bool is_last, uint64_t session_id) {
...
void TraderApi::OnQueryOptionCombinedTrades(XTPQueryOptCombTradeRsp *trade_info, XTPRI *error_info, int request_id,
                                            bool is_last, uint64_t session_id) {
...
void TraderApi::OnQueryOptionCombinedTradesByPage(XTPQueryOptCombTradeRsp *trade_info, int64_t req_count,
                                                  int64_t trade_sequence, int64_t query_reference, int request_id,
                                                  bool is_last, uint64_t session_id) {
...
void
TraderApi::OnQueryOptionCombinedPosition(XTPQueryOptCombPositionRsp *position_info, XTPRI *error_info, int request_id,
                                         bool is_last, uint64_t session_id) {
...
void TraderApi::OnQueryOptionCombinedStrategyInfo(XTPQueryCombineStrategyInfoRsp *strategy_info, XTPRI *error_info,
                                                  int request_id, bool is_last, uint64_t session_id) {
    Task *task = new Task();
...
void TraderApi::OnQueryOptionCombinedExecPosition(XTPQueryOptCombExecPosRsp *position_info, XTPRI *error_info,
                                                  int request_id, bool is_last, uint64_t session_id) {
    Task *task = new Task();
...
void
TraderApi::OnQueryOtherServerFund(XTPFundQueryRsp *fund_info, XTPRI *error_info, int request_id, uint64_t session_id) {
    Task *task = new Task();
...
void TraderApi::processQueryOrderByPage(Task *task) {
    ...
    this->onQueryOrderByPage(data, task->addtional_int_two, task->addtional_int_three, task->addtional_int_four,
                             task->task_id, task->task_last, task->addtional_int);
    delete task;
};
...
void TraderApi::processQueryTradeByPage(Task *task) {
    ...
    this->onQueryTradeByPage(data, task->addtional_int_two, task->addtional_int_three, task->addtional_int_four,
                             task->task_id, task->task_last, task->addtional_int);
    delete task;
};
...
void TraderApi::processQueryOptionCombinedOrdersByPage(Task *task) {
    ...
    this->onQueryOptionCombinedOrdersByPage(data, task->req_count, task->order_sequence, task->query_reference,
                                            task->task_id, task->task_last, task->addtional_int);
}
...
void TraderApi::processQueryOptionCombinedTradesByPage(Task *task) {
    ...
    this->onQueryOptionCombinedTradesByPage(data, task->req_count, task->trade_sequence, task->query_reference,
                                            task->task_id, task->task_last, task->addtional_int);
}
...
uint64_t TraderApi::insertOptionCombinedOrder(dict req, uint64_t session_id) {
    ...
    for (int i = 0; i < query_param.opt_comb_info.num_legs; i++) {
        getNestedDictChar2(req, "opt_comb_info", "leg_detail", "leg_security_id",
                           query_param.opt_comb_info.leg_detail[i].leg_security_id, i);
        ...
        getNestedDictValue2(req, "opt_comb_info", "leg_detail", "leg_qty",
                            &query_param.opt_comb_info.leg_detail[i].leg_qty, i);
...
struct TraderApiWrap : TraderApi, wrapper<TraderApi> {
    ...
    virtual void
    onQueryOrderByPage(dict data, int64_t req_count, int64_t order_sequence, int64_t query_reference, int reqid,
                       bool last, uint64_t session) {
        try {
            this->get_override("onQueryOrderByPage")(data, req_count, order_sequence, query_reference, reqid, last,
                                                     session);
        }
        catch (error_already_set const &) {
            PyErr_Print();
    ...
    virtual void
    onQueryTradeByPage(dict data, int64_t req_count, int64_t trade_sequence, int64_t query_reference, int reqid,
                       bool last, uint64_t session) {
        try {
            this->get_override("onQueryTradeByPage")(data, req_count, trade_sequence, query_reference, reqid, last,
                                                     session);
        }
        catch (error_already_set const &) {
            PyErr_Print();
    ...
    virtual void
    onQueryCreditCashRepayInfo(dict data, dict error_info, int request_id, bool is_last, uint64_t session) {
        PyLock lock;
    ...
    virtual void
    onQueryCreditTickerDebtInfo(dict data, dict error_info, int request_id, bool is_last, uint64_t session) {
        PyLock lock;
    ...
    virtual void
    onQueryCreditTickerAssignInfo(dict data, dict error_info, int request_id, bool is_last, uint64_t session) {
        PyLock lock;
    ...
    virtual void
    onQueryMulCreditExcessStock(dict data, dict error_info, int request_id, uint64_t session, bool is_last) {
        PyLock lock;
    ...
    virtual void
    onQueryCreditExtendDebtDateOrders(dict data, dict error_info, int request_id, bool is_last, uint64_t session) {
        PyLock lock;
    ...
    virtual void
    onQueryCreditPositionExtraInfo(dict data, dict error_info, int request_id, bool is_last, uint64_t session) {
        PyLock lock;
    ...
    virtual void
    onQueryOptionCombinedOrders(dict data, dict error_info, int request_id, bool is_last, uint64_t session_id) {
        PyLock lock;
    ...
    virtual void
    onQueryOptionCombinedOrdersByPage(dict data, int64_t req_count, int64_t order_sequence, int64_t query_reference,
                                      int request_id, bool is_last, uint64_t session_id) {
        PyLock lock;

        try {
            this->get_override("onQueryOptionCombinedOrdersByPage")(data, req_count, order_sequence, query_reference,
                                                                    request_id, is_last, session_id);
        } catch (error_already_set const &) {
            PyErr_Print();
        }
    };
    ...
    virtual void
    onQueryOptionCombinedTrades(dict data, dict error_info, int request_id, bool is_last, uint64_t session_id) {
        PyLock lock;
    ...
    virtual void
    onQueryOptionCombinedTradesByPage(dict data, int64_t req_count, int64_t trade_sequence, int64_t query_reference,
                                      int request_id, bool is_last, uint64_t session_id) {
        PyLock lock;

        try {
            this->get_override("onQueryOptionCombinedTradesByPage")(data, req_count, trade_sequence, query_reference,
                                                                    request_id, is_last, session_id);
        } catch (error_already_set const &) {
            PyErr_Print();
        }
    ...
    virtual void
    onQueryOptionCombinedPosition(dict data, dict error_info, int request_id, bool is_last, uint64_t session_id) {
        PyLock lock;
    ...
    virtual void
    onQueryOptionCombinedStrategyInfo(dict data, dict error_info, int request_id, bool is_last, uint64_t session_id) {
        PyLock lock;
    ...
    virtual void
    onQueryOptionCombinedExecPosition(dict data, dict error_info, int request_id, bool is_last, uint64_t session) {
        PyLock lock;
